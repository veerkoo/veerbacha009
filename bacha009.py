...
\033[1;32m└───────────────────────────────────────┘  
         \033[41m\033[1;37m𝐓𝐎𝐎𝐋 𝐀𝐃𝐌𝐈𝐍 [VEER] [KHANOO]\x1b[0m    
 """)
		...
		print("")
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2012-15 %s(FREE)"%(G,R,G,Y,W))
		print("%s [%s2%s]%s CRACK RANDOM FB ID 2011-13 %s(FREE)"%(G,R,G,Y,W))
		print("%s [%s3%s]%s CRACK RANDOM FB ID 2008-11 %s(FREE)"%(G,R,G,Y,W))
		print("%s [%s4%s]%s CRACK RANDOM FB ID 2009    %s(FREE)"%(G,R,G,Y,W))
		...
		print("%s [%s8%s]%s CRACK RANDOM FB ID 2004 %s(Maintenance Break) V3"%(R,G,R,Y,G))
		print("%s [%s9%s]%s CRACK FROM EMAILS %s(FREE)"%(G,R,G,Y,W))
		print(GET)
		hoga = input("\n%s [?] CHOICE : "%(B))
		if hoga in ["", " "]:
			Main()
